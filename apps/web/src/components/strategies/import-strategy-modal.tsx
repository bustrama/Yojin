...
import { useImportStrategy } from '../../api/hooks/index.js';
...
export default function ImportStrategyModal({ open, onClose }: ImportStrategyModalProps) {
  ...
  const handleImport = async () => {
    ...
    setLoading(true);
    try {
      const result = await importStrategy({ markdown });
