      ...
      // Stage 2: Strategist — 1 iteration to batch all tool calls, 1 to emit final text
      {
        ...
        buildMessage: (prev) => {
          ...
          prompt +=
            ...
            `Fields:\n` +
            `- positions[]: symbol, name, rating (VERY_BULLISH/BULLISH/NEUTRAL/BEARISH/VERY_BEARISH), conviction, thesis (2-3 sentences of narrative prose explaining WHY — cite macro/sector/geopolitical drivers. Follow Writing Standards Rule 3 in your system prompt: never a bare indicator reading. Cross-position links ONLY with concrete evidence: cite it and estimate impact. Do NOT invent connections), keySignals[] (top 2 per position), risks[] (1-2, full phrases — ticker-specific risks belong HERE, not in portfolio.topRisks), opportunities[] (1-2, full phrases — ticker-specific opportunities belong HERE, not in portfolio.topOpportunities), memoryContext: null, priceTarget: null\n` +
