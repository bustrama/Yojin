...
> **⚠️ Not financial advice.** Yojin is a software tool for personal research and portfolio monitoring. Nothing it generates — insights, signals, ratings, strategies, or suggested actions — constitutes financial, investment, tax, or legal advice, nor a recommendation, solicitation, or offer to buy or sell any security or asset. Outputs are generated by AI and may be inaccurate, incomplete, or out of date. You are solely responsible for your own investment decisions. See the [Disclaimer](#disclaimer) below.
...
**Yojin is not a broker-dealer, investment adviser, or financial institution, and does not provide financial, investment, tax, or legal advice.** It is a software tool that helps you organize portfolio data and surface AI-generated research for your own personal use.

- **No advice.** Insights, ratings, signals, strategies, and suggested actions produced by Yojin or its agents are informational only. They are not recommendations to buy, sell, or hold any security, crypto asset, or other instrument.
- **AI output can be wrong.** Large language models can hallucinate, miss context, and misread markets. Always verify anything material with primary sources and a qualified professional.
- **You make the decisions.** Any trade that Yojin places on a connected platform is an action you explicitly approved. You are solely responsible for your orders, account activity, tax treatment, and compliance with the laws and regulations that apply to you.
- **No fiduciary relationship.** Using Yojin does not create a fiduciary, advisory, or brokerage relationship between you and the project, its maintainers, or its contributors.
- **Investing is risky.** Markets can lose value rapidly. Past performance is not indicative of future results. Never invest money you cannot afford to lose.
- **As-is software.** Yojin is provided under the MIT License, **without warranty of any kind**. The maintainers and contributors accept no liability for losses, damages, or costs arising from its use.

If you need personalized financial guidance, consult a licensed financial adviser, broker, or tax professional in your jurisdiction.
